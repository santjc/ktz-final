...
function preload() {
    ...
    flags[7] = loadImage("./assets/key_directional2.png");
    flags[8] = loadImage("./assets/key_fire2.png");

    // flags[9] = loadImage("./assets/skull.png");
    flags[9] = loadImage("./assets/bomb-2.png");
...
function draw() {
    ...
    // if ((timerValue == timer_game_max) && (screen == SCR_INSTRUCTIONS)) {
    ...
    if (screen == SCR_GAMEPLAY) {
        ...
        /* TODO: Handle offf creen movements */
